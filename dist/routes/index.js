...
// post routess //
exports.router.post("/signin", passport_1.default.authenticate("local", { failureRedirect: "/login-failure", successRedirect: "/login-success" }), (req, res, next) => {
    console.log(passport_1.default.authenticate("local"));
});
